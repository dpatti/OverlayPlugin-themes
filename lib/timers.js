...
var RowKey = /*#__PURE__*/function () {
  function RowKey(actionID, sourceID) {
    _classCallCheck(this, RowKey);
  ...
  _createClass(RowKey, [{
    ...
    value: function toString() {
      return "".concat(this.actionID, "|").concat(this.sourceID);
    }
  }]);
...
var Timers = /*#__PURE__*/function (_React$Component2) {
  ...
  _createClass(Timers, [{
    ...
    value: function render() {
      ...
      var timers = []; // Here we're traversing through a three-layer map of keys that comprise
        ...
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              ...
              var events = Array.from(bySource.entries());
              ...
              if (events.length > 0) {
                ...
                var key = new RowKey(action, source);
...
var App = /*#__PURE__*/function (_React$Component3) {
  ...
  _createClass(App, [{
    ...
    key: "dismissRow",
    value: function dismissRow(_ref7) {
      var actionID = _ref7.actionID,
          sourceID = _ref7.sourceID;
      this.setState({
        actions: this.state.actions.update(actionID, function (byAction) {
          return byAction.update(sourceID, function (_) {
            return new Map();
          });
        })
      });
