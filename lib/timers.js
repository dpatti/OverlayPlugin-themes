...
var Timers = /*#__PURE__*/function (_React$Component2) {
  ...
  _createClass(Timers, [{
    ...
    value: function render() {
      ...
      var timers = Array.from(this.props.tracking).flatMap(function (_ref3) {
        ...
        if (targets.size === 0) {
          ...
          var event = _.maxBy(Array.from(targets.values()), "castAt");
      ...
      var ranking = [function (_ref5) {
        var state = _ref5.state;
        return state === "active" ? 0 : 1;
      }, function (_ref6) {
        var timer = _ref6.timer;
        return timer;
      }];
