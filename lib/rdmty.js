...
var ChartView = /*#__PURE__*/function (_React$Component2) {
  _inherits(ChartView, _React$Component2);

  var _super2 = _createSuper(ChartView);
...
var Header = /*#__PURE__*/function (_React$Component3) {
  ...
  function Header(props) {
    ...
    _this.handleEndEncounter = _this.handleEndEncounter.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        className: "header ".concat(this.state.expanded ? "" : "collapsed")
      }, /*#__PURE__*/React.createElement("div", {
      ...
      }, encounter.title, /*#__PURE__*/React.createElement("div", {
      ...
      }, "Current Fight"), EncountersArray.map(function (encounter, i) {
        return /*#__PURE__*/React.createElement("div", {
          key: i,
        ...
        className: "duration"
      }, "(", encounter.duration, ")"), /*#__PURE__*/React.createElement("span", {
      ...
      }, this.props.currentView), /*#__PURE__*/React.createElement("div", {
        className: "ff-header",
        style: {
          "float": "right",
          paddingLeft: "1em"
        }
      }, "rdps: ", formatNumber(rdps)), /*#__PURE__*/React.createElement("div", {
        className: "ff-header",
      ...
      }, "End Encounter")), /*#__PURE__*/React.createElement("div", {
    ...
    value: function render() {
      ...
      for (var i = 0; i < names.length; i++) {
        ...
        if (combatant.Job !== "") {
          ...
          if (stats) {
            rows.push( /*#__PURE__*/React.createElement(CombatantCompact, _extends({
              onClick: this.props.onClick,
      ...
      if (this.state.selectedEncounter) {
        ...
        if (this.state.currentViewIndex === 1) {
          data = _.sortBy(_.filter(data, function (d) {
            ...
            if (_this3.state.currentViewIndex === 1) {
            ...
            data = _.sortBy(_.filter(data, function (d) {
              ...
              if (_this3.state.currentViewIndex === 2) {
