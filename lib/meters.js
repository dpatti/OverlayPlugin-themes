...
var options = function (search) {
  ...
  return {
    you: ((_options$you = options.you) === null || _options$you === void 0 ? void 0 : _options$you.replace(/_/g, " ")) || YOU,
    ...
    value: function render() {
      ...
      var rows = _.take(this.props.combatants, maxRows).map(function (combatant, rank) {
        ...
        var stats = _.merge({
          ...
          note: "".concat(combatant.OverHealPct, " OH"),
          ...
          extra: ["".concat(combatant.ParryPct, " parry"), "".concat(combatant.BlockPct, " block")]
...
var DamageMeter = /*#__PURE__*/function (_React$Component5) {
  ...
  _createClass(DamageMeter, [{
    ...
    value: function render() {
      ...
      var self = encounter.Combatant[(_this$props$playerNam = this.props.playerName) !== null && _this$props$playerNam !== void 0 ? _this$props$playerNam : YOU];
