...
var Header = /*#__PURE__*/function (_React$Component2) {
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      var self = data["YOU"];
      var rdps = parseFloat(encounter.encdps); // This is the switcher for Toggling group info or self info
      ...
      }, "Current Fight"), EncounterHistory.map(function (encounter, i) {
        return /*#__PURE__*/React.createElement("div", {
          key: i,
...
var Combatants = /*#__PURE__*/function (_React$Component3) {
  ...
  _createClass(Combatants, [{
    ...
    value: function render() {
      ...
      var rows = _.take(this.props.data, maxRows).filter(function (combatant) {
        return combatant.Job !== "";
      }).map(function (combatant, rank) {
        var stats;
...
var DamageMeter = /*#__PURE__*/function (_React$Component4) {
  ...
  _createClass(DamageMeter, [{
    ...
    value: function handleSelectEncounter(index) {
      if (index >= 0) {
        this.setState({
