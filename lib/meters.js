  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: "ff-header view-color ".concat(this.props.currentView.toLowerCase()),
        style: {
          "float": "right",
          cursor: "pointer"
        },
...
var App = /*#__PURE__*/function (_React$Component6) {
  ...
  _createClass(App, [{
    ...
    value: function onOverlayDataUpdate(e) {
      ...
      var history = this.state.history; // save this encounter data

      if (this.state.parseData && this.state.parseData.Encounter.title === "Encounter" && parseData.Encounter.title !== "Encounter") {
        history = [{
