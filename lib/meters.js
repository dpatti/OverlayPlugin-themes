  ...
  _createClass(CombatantCompact, [{
    ...
    value: function render() {
      ...
      return this.props.perSecond === "---" ? null : /*#__PURE__*/React.createElement("li", {
        ...
        className: "total"
      }, formatNumber(this.props.total)), this.props.additional ? /*#__PURE__*/React.createElement("span", {
        className: "additional"
      }, "[", this.props.additional, "]") : null, this.props.perSecond !== null ? "(".concat(this.props.perSecond, ", ").concat(this.props.percentage, ")") : null), /*#__PURE__*/React.createElement("div", {
        className: "info"
      }, /*#__PURE__*/React.createElement("span", {
        className: "job-icon"
      }), /*#__PURE__*/React.createElement("span", {
...
var Header = /*#__PURE__*/function (_React$Component2) {
  ...
  _createClass(Header, [{
    ...
    value: function toggleExtraDetails() {
      this.setState({
    ...
    value: function render() {
      ...
      var self = combatants[YOU]; // This is the switcher for Toggling group info or self info
      ...
      if (this.state.group) {
        if (combatants !== undefined) {
          for (var x in combatants) {
            if (!Object.prototype.hasOwnProperty.call(combatants, x)) continue;
            DirectHitPct += parseFloat(combatants[x].DirectHitPct.substring(0, combatants[x].DirectHitPct.length - 1));
            CritDirectHitPct += parseFloat(combatants[x].CritDirectHitPct.substring(0, combatants[x].CritDirectHitPct.length - 1));
            datalength++;
          }
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        onClick: function onClick() {
          return _this2.toggleEncounterMenu();
        }
        ...
        onClick: function onClick() {
          return _this2.onSelectEncounter(null);
        }
      ...
      }, this.props.currentView == View.Damage ? /*#__PURE__*/React.createElement("div", {
        className: "data-set-view-switcher clearfix",
        onClick: function onClick() {
          return _this2.toggleStats();
        }
      }, /*#__PURE__*/React.createElement("span", {
    ...
    value: function render() {
      ...
      var rows = _.take(this.props.combatants, maxRows).map(function (combatant, rank) {
        ...
        var stats = _.merge({
          ...
          perSecond: null,
          percentage: null
        }), _View$Damage$View$Hea2)[_this3.props.currentView]);
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        onViewChange: function onViewChange() {
          return _this5.handleViewChange();
        },
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      document.addEventListener("onOverlayDataUpdate", function (e) {
        return _this7.onOverlayDataUpdate(e);
      });
      document.addEventListener("onOverlayStateUpdate", function (e) {
        return _this7.onOverlayStateUpdate(e);
      });
    ...
    value: function render() {
      ...
      return this.state.parseData ? /*#__PURE__*/React.createElement(DamageMeter, {
        ...
        onSelectEncounter: function onSelectEncounter(index) {
          return _this8.onSelectEncounter(index);
        }
