...
var App = /*#__PURE__*/function (_React$Component7) {
  ...
  _createClass(App, [{
    ...
    value: function onLogLine(e) {
      var _this$state$currentEn,
          _this10 = this;

      // If we aren't in an encounter, don't calculate uptime
      if (((_this$state$currentEn = this.state.currentEncounter) === null || _this$state$currentEn === void 0 ? void 0 : _this$state$currentEn.isActive) !== "true") return;
